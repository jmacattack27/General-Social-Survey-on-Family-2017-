...
abstract: "What does family look like in Canada? Using data from the 2017 Canadian General Social Survey (GSS) on Family, we take a look at this picture through the lens of family size and type, marriage and children, place of origin, income, religion and mental health. We found that most families are small, well-off and in good mental health, and that immigrants make up about one fifth of the population, settling in the larger cities and adding diversity in ethnicity and languages to the family scene. We also discuss possible factors that may have influenced this family image, including Canada's investment in family planning and immigration levels planning."
output:
