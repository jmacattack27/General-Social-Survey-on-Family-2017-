...
Figure \@ref(fig:immigrantsarrival) shows the years that respondents who were born outside of Canada reported arriving in Canada, as well as where they hailed from. Notably the population of Europeans made up the largest proportion of immigrants and was at its peak from 1946 to 1959, but decreased dramatically until 1970, and has since remained almost constant. In contrast, the population of Asian immigrants has been increasing steadily since 1979, with Asian immigrants accounting for the largest proportion of immigrants since about 1985. The number of immigrants from the Americas has remained relatively constant since 1965, while the number of African immigrants has been steadily increasing since 2000. 
...
knitr::include_graphics("D:/UofT/Y3 Winter/STA304/General-Social-Survey-on-Family-2017-/inputs/data")
```

![Survey Image 1](https://drive.google.com/uc?id=105Sr09qXQPzrvFUNmOd1qHG84V94jDEn)
![Survey Image 2](https://drive.google.com/uc?id=107y1yW9TqJINgvVqm0yfXLsdzld2BRtQ)
![Survey Image 3](https://drive.google.com/uc?id=107JteNN_kV37zsazeSRil85HA-Mur9YG)
![Survey Image 4](https://drive.google.com/uc?id=104sehzXe95lAC71JAclYGfhQ5Lpzh6sX)
![Survey Image 5](https://drive.google.com/uc?id=10ASJKQVaztg8YXOqzUTM1U1G4dCT0Z2B)
